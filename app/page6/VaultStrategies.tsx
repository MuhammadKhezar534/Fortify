          ...
          <div className=" flex flex-col lg:flex-row items-center lg:justify-between">
            <div className="basis-[45%] space-y-5">
              ...
              <p className=" text-t-16 text-darken font-medium">
                The USDC Vault has a number of parameters used to guide its
                ...
                for the USDC Vault are Vector Finance, Delta Prime, and Yield
                Yak. To learn more about the strategies used in the USDC
